      ...
      <div className="container mx-auto flex justify-between items-center py-3 m-4">
        ...
        <div className="relative md:hidden">
          <button
            ...
            className="text-white text-base no-underline px-4 py-3 block rounded-sm"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
          ...
          {isDropdownOpen && (
            <ul className="absolute right-0 mt-2 py-3 w-36 bg-neutral-300 rounded-lg shadow-xl font-bold">
              <li className="m-1">
                <a
                  href="#"
                  className="text-gray-800 text-base no-underline px-4 py-3 block hover:bg-neutral-200 rounded-lg flex items-center"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <li className="m-1 flex hover:bg-neutral-200 rounded-lg">
                <a
                  href="#"
                  className="text-gray-800 text-base no-underline px-4 py-3 block flex items-center"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
